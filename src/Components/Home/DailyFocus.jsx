...
const DailyFocus = () => {
  const [tasks, setTasks] = useState([
    {
      id: 1,
      title: "৫ ওয়াক্ত নামাজ (জামাতের সাথে)",
      category: "ধর্মীয়",
      done: false,
      icon: <Heart size={20} />,
    },
    ...
    {
      id: 3,
      title: "৩ ঘণ্টা ডিপ ওয়ার্ক (কোডিং)",
      category: "কাজ",
      done: false,
      icon: <Target size={20} />,
    },
    {
      id: 4,
      title: "কুরআন তিলাওয়াত ও সকালের দোয়া",
      category: "ধর্মীয়",
      done: false,
    ...
    {
      id: 6,
      title: "রাত ১০:৩০ এর মধ্যে ঘুমানো",
      category: "স্বাস্থ্য",
      done: false,
      icon: <Zap size={20} />,
    },
  ...
  useEffect(() => {
    if (progressPercentage === 100 && mounted) {
      ...
      toast.custom(
        (t) => (
          <div
            className={`${t.visible ? "animate-bounce" : "animate-leave"} max-w-md w-full bg-gradient-to-r from-yellow-400 via-orange-500 to-rose-500 shadow-2xl rounded-[2rem] p-6 flex items-center gap-4 border-2 border-white/20`}
          >
            ...
            <div>
              ...
              <p className="text-orange-50 text-sm font-medium">
                মাশাআল্লাহ, আপনি আজকের সব লক্ষ্য পূরণ করেছেন!
              </p>
            </div>
          </div>
        ),
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="mb-12 flex flex-col lg:flex-row justify-between items-center gap-6">
          <div className="text-center lg:text-left">
            ...
            <p className="mt-2 text-slate-500 font-medium tracking-wide text-lg">
              আজকের কাজের অগ্রগতি রিপোর্ট
            </p>
          </div>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
            ...
            {tasks.map((task) => (
              ...
              >
                <div className="flex items-center gap-5 relative z-10">
                  <div
                    className={`transition-all duration-500 ${task.done ? "text-emerald-500 scale-110" : "text-slate-300 group-hover:text-indigo-500"}`}
                  >
                    {task.done ? (
                      <div className="relative">
                        <CheckCircle2
                          size={36}
                          fill="currentColor"
                          className="text-white dark:text-emerald-900"
                        />
                        <span className="absolute -top-1 -right-1 animate-ping text-rose-500">
                  ...
                  <div>
                    <h3
                      className={`font-bold text-xl ${task.done ? "text-slate-400 line-through" : "text-slate-800 dark:text-slate-100"}`}
                    >
                      {task.title}
                    </h3>
                    <span
                      className={`text-[11px] font-black uppercase tracking-widest mt-1 block px-2 py-0.5 rounded-lg w-fit ${task.done ? "bg-emerald-100 text-emerald-600" : "bg-slate-100 text-slate-500 dark:bg-white/5"}`}
                    >
                      {task.category}
                    </span>
                  </div>
                ...
                <div
                  className={`font-black text-4xl opacity-5 ${task.done ? "text-emerald-500" : "text-slate-900"}`}
                >
                  ০{task.id}
                </div>
              </div>
          ...
          <div className="flex-1">
            <div
              className={`sticky top-24 rounded-[3.5rem] p-10 text-white transition-all duration-1000 overflow-hidden shadow-2xl
                            ${
                              progressPercentage === 100
            ...
            >
              <div className="relative z-10 text-center">
                <Trophy
                  size={64}
                  className={`mx-auto mb-6 ${progressPercentage === 100 ? "animate-bounce text-yellow-300" : "text-slate-700"}`}
                />
                <h3 className="text-7xl font-black tracking-tighter">
                  {progressPercentage}%
                </h3>
                <p className="text-sm opacity-80 font-bold uppercase tracking-widest mt-2">
                  দক্ষতা স্কোর
                </p>
